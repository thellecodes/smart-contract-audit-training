...
import {IERC721Token, IPoolErrors, IPoolLenderActions, IPoolKickerActions, IPoolTakerActions, IPoolSettlerActions} from "./interfaces/pool/IPool.sol";
...
import {IERC721Pool, IERC721PoolBorrowerActions, IERC721PoolImmutables, IERC721PoolLenderActions} from "./interfaces/pool/erc721/IERC721Pool.sol";
...
contract ERC721Pool is FlashloanablePool, IERC721Pool {
    ...
    function repayDebt(
        ...
        if (noOfNFTsToPull_ != 0) {
            ...
            _transferFromPoolToAddress(
                collateralReceiver_,
                borrowerTokenIds[msg.sender],
                noOfNFTsToPull_
            );
        }
    }
    ...
    function mergeOrRemoveCollateral(
        ...
        override
        nonReentrant
        returns (uint256 collateralMerged_, uint256 bucketLP_)
    {
        ...
        (collateralMerged_, bucketLP_) = LenderActions.mergeOrRemoveCollateral(
            buckets,
            deposits,
            removalIndexes_,
            collateralAmount,
    ...
    function take(
        ...
        uint256 totalQuoteTokenAmount = result.quoteTokenAmount +
        ...
        if (result.excessQuoteToken != 0)
            _transferQuoteToken(borrowerAddress_, result.excessQuoteToken);
    }
    ...
    function _rebalanceTokens(
        ...
        */
        uint256 borrowerCollateralRoundedUp = (borrowerCollateral_ + 1e18 - 1) /
            1e18;
        uint256 noOfTokensToTransfer = noOfTokensPledged -
            borrowerCollateralRoundedUp;
    ...
    function _transferNFT(
        ...
        IERC721Token(_getArgAddress(COLLATERAL_ADDRESS)).transferFrom(
            from_,
            to_,
            tokenId_
        );
